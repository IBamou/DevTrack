...
>
    <!-- Logo -->
    <div class="flex items-center h-16 flex-shrink-0 border-b border-slate-100" :class="collapsed ? 'justify-center px-2' : 'px-5'">
    ...
    <nav class="flex-1 py-4 space-y-1.5 overflow-y-auto" :class="collapsed ? 'px-2' : 'px-3'">
        ...
        <x-ui.nav-item
            ...
            :active="request()->routeIs('projects.index') || request()->routeIs('projects.show') || request()->routeIs('projects.edit')"
        >
            <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
        ...
        <x-ui.nav-item
            ...
            :active="request()->routeIs('projects.archives')"
        >
            <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
    ...
    <!-- New Project Button -->
    <div class="flex-shrink-0 px-4 pb-3" :class="collapsed ? 'px-2' : 'px-4'">
        <a
            href="{{ route('projects.create') }}"
            class="flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-blue-700"
            :class="collapsed ? 'px-0' : ''"
        >
            <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
            </svg>
            <span x-show="!collapsed" x-cloak class="whitespace-nowrap">New Project</span>
        </a>
    </div>
