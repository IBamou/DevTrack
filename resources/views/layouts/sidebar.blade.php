...
<div
    ...
    class="bg-gradient-to-b from-slate-900 to-slate-800 text-white shadow-xl h-screen flex flex-col fixed left-0 top-0 transition-all duration-300 ease-in-out overflow-hidden">
    <!-- Logo Section -->
    <div class="p-6 border-b border-slate-700">
        <a href="{{ route('dashboard') }}"
            ...
            <span x-show="!sidebarCollapsed">DevTrack</span>
        </a>
    </div>
    ...
    <nav class="flex-1 px-4 py-8 space-y-2 overflow-y-auto">
        <a href="{{ route('dashboard') }}"
            ...
            <span x-show="!sidebarCollapsed" class="text-sm font-medium whitespace-nowrap">Tableau de bord</span>
        </a>
        ...
        <a href="{{ route('projects.index') }}"
            ...
            <span x-show="!sidebarCollapsed" class="text-sm font-medium whitespace-nowrap">Projets</span>
        </a>
        ...
        <a href="{{ route('projects.archives') }}"
            ...
            <span x-show="!sidebarCollapsed" class="text-sm font-medium whitespace-nowrap">Archives</span>
        </a>
    </nav>
    ...
    <div class="border-t border-slate-700 p-4">
        <button
            ...
            <svg x-show="!sidebarCollapsed" class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
