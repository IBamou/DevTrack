        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-6 lg:p-8">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
                    ...
                    <a href="{{ route('projects.index') }}"
                        class="inline-flex items-center justify-center rounded-md border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-700 shadow-sm hover:bg-slate-50 focus:outline-none mt-4 sm:mt-0">
                        <svg class="w-5 h-5 mr-2 text-slate-500" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-4.991-2.693L7.985 5.989m10.158 1.953l-3.181-3.182A8.25 8.25 0 004.828 7.5M12 6a.75.75 0 100-1.5.75.75 0 000 1.5z" />
                        </svg>
                        Active Projects
                    </a>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                    <div class="bg-white rounded-lg shadow-sm p-5 flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm text-slate-500">Total Archived</p>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-5 flex items-center">
                        <div class="p-3 rounded-full bg-green-100 text-green-600">
                            <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M21 16V8a2 2 0 00-1-1.732l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.732l7 4a2 2 0 002 0l7-4A2 2 0 0021 16zM3.27 6.96l7.443-4.253a.25.25 0 01.254 0l7.443 4.253M12 21.75v-10.5" />
                            </svg>
                        </div>
                        <div class="ml-4">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-5 flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm text-slate-500">Oldest Entry</p>
                            <p class="text-2xl font-bold">{{ $projects->first() ? $projects->first()->deleted_at->diffForHumans() : 'N/A' }}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm flex flex-col">
                            ...
                            <div class="flex justify-between items-start">
                                ...
                                <div class="flex -space-x-2">
                                    ...
                                    <img class="inline-block h-8 w-8 rounded-full ring-2 ring-white"
                                        src="{{ $collaborator->profile_photo_url ?? 'https://ui-avatars.com/api/?name=' . urlencode($collaborator->name) }}" alt="">
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="border-t border-slate-200 mt-auto flex divide-x divide-slate-200">
                            <form action="{{ route('projects.restore', $project) }}" method="POST" class="w-full">
                                ...
                                <button type="submit" class="w-full py-3 text-sm font-medium text-slate-600 hover:bg-slate-50 flex items-center justify-center">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h5M20 20v-5h-5M4 4l16 16"></path>
                                    </svg>
                                    Restore
                                </button>
                            </form>
                            <form action="{{ route('projects.forceDelete', $project) }}" method="POST" class="w-full">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="w-full py-3 text-sm font-medium text-red-600 hover:bg-slate-50 flex items-center justify-center" onclick="return confirm('Permanently delete this project?')">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1 10V10a2 2 0 00-2-2H8a2 2 0 00-2 2v10a2 2 0 002 2h2a2 2 0 002-2z" />
                                    </svg>
                                    Delete
                                </button>
                            </form>
